...
. Copy then unpack the downloaded zip file to *CN-Workshop-PIT/labs/my_work/cloud-native-spring*
+
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /cloud-native-spring directory (e.g. CN-Workshop-PIT/labs/my_work/cloud-native-spring)
...
. In a terminal, change working directory to *CN-Workshop-PIT/labs/my_work/cloud-native-spring*
+
$ cd /CN-Workshop-PIT/labs/my_work/cloud-native-spring
