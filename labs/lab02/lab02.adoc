...
. Add this https://raw.githubusercontent.com/Pivotal-Field-Engineering/CN-Workshop-PIT/master/labs/lab02/import.sql[import.sql file] found in *CN-Workshop-PIT/labs/lab02/* to +src/main/resources+. This is a rather large dataset containing all of the postal codes in the United States and its territories. This file will automatically be picked up by Hibernate and imported into the in-memory database.
...
#0   running   2014-05-27 04:15:05 PM   0.0%   433M of 1G     128.9M of 1G
---------------------------------------------------------------------
